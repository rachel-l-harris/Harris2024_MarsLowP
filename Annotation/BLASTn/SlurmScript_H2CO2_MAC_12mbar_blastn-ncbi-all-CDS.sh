...
#SBATCH -J array_H2CO2_MAC_12mbar_blastn_ncbi-all-CDS
#SBATCH -n 1 #--ntasks
#SBATCH -c 16 #--cpus_per-task
#SBATCH -N 1 #node count
#SBATCH -t 0-168:00:00 #--run time in hours
#SBATCH -p bigmem_intermediate #--partition
#SBATCH --mem=350G #--memory request in GB
#SBATCH -o /n/holyscratch01/girguis_lab/rachel_harris/Mars_low-pressure/H2CO2/MAC_12mbar/cds_KEGG-mby-all-CDS/mappedReads/blastn/array_H2CO2_MAC_12mbar_blastn_ncbi-all-CDS_mapping_%A_%a.out
#SBATCH -e /n/holyscratch01/girguis_lab/rachel_harris/Mars_low-pressure/H2CO2/MAC_12mbar/cds_KEGG-mby-all-CDS/mappedReads/blastn/array_H2CO2_MAC_12mbar_blastn_ncbi-all-CDS_mapping_%A_%a.err
#SBATCH --array=0-5
...
echo ""
echo "####################################"
echo "BLASTn H2CO2/MAC_12mbar MAPPED READS"
echo "#####################################"
echo ""
echo "cd H2CO2/MAC_12mbar/cds_KEGG-mby-all-CDS/mappedReads/mappers"
cd H2CO2/MAC_12mbar/cds_KEGG-mby-all-CDS/mappedReads/mappers
echo ""
