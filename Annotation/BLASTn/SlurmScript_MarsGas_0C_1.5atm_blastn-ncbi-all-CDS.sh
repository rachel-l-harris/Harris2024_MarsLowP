...
#SBATCH -J array_MarsGas_0C_1.5atm_blastn_ncbi-all-CDS
#SBATCH -n 1 #--ntasks
#SBATCH -c 1 #--cpus_per-task
#SBATCH -N 1 #node count
#SBATCH -t 0-4:00:00 #--run time in hours
#SBATCH -p shared #--partition
#SBATCH --mem=32G #--memory request in GB
#SBATCH -o /n/holyscratch01/girguis_lab/rachel_harris/Mars_low-pressure/MarsGas/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/blastn/array_MarsGas_0C_1.5atm_blastn_ncbi-all-CDS_mapping_%A_%a.out
#SBATCH -e /n/holyscratch01/girguis_lab/rachel_harris/Mars_low-pressure/MarsGas/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/blastn/array_MarsGas_0C_1.5atm_blastn_ncbi-all-CDS_mapping_%A_%a.err
#SBATCH --array=0-3
...
echo ""
echo "####################################"
echo "BLASTn MarsGas/0C_1.5atm MAPPED READS"
echo "#####################################"
echo ""
echo "cd MarsGas/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/mappers"
cd MarsGas/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/mappers
echo ""

echo "Load the sample names into a bash array"
echo "samples=(12a_A1-0C1 12a_A1-0C2 12b_A1-0C1 12b_A1-0C2)"
samples=(12a_A1-0C1 12a_A1-0C2 12b_A1-0C1 12b_A1-0C2)
echo ""
