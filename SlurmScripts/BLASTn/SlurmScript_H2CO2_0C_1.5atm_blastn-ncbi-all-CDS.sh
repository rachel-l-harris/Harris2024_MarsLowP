...
#SBATCH -J array_H2CO2_0C_1.5atm_blastn_ncbi-all-CDS
#SBATCH -n 1 #--ntasks
...
#SBATCH -o /n/holyscratch01/girguis_lab/rachel_harris/Mars_low-pressure/H2CO2/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/blastn/array_H2CO2_0C_1.5atm_blastn_ncbi-all-CDS_mapping_%A_%a.out
#SBATCH -e /n/holyscratch01/girguis_lab/rachel_harris/Mars_low-pressure/H2CO2/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/blastn/array_H2CO2_0C_1.5atm_blastn_ncbi-all-CDS_mapping_%A_%a.err
#SBATCH --array=0-5
...
echo ""
echo "####################################"
echo "BLASTn H2CO2/0C_1.5atm MAPPED READS"
echo "#####################################"
echo ""
echo "cd H2CO2/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/mappers"
cd H2CO2/0C_1.5atm/cds_KEGG-mby-all-CDS/mappedReads/mappers
echo ""

echo "Load the sample names into a bash array"
echo "samples=(A1-0C2 A2-0C2 A3-0C1 A3-0C2 A4-0C1 A4-0C2)"
samples=(A1-0C2 A2-0C2 A3-0C1 A3-0C2 A4-0C1 A4-0C2)
echo ""
